    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegisterButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                RootRef.addListenerForSingleValueEvent(new ValueEventListener()
                {
                    ...
                    {
                        if (!(dataSnapshot.child("Admin").child(phone_no).exists()))
                        {
                            ...
                            RootRef.child("Admin").child(phone_no).updateChildren(userdataMap)
                                    .addOnCompleteListener(new OnCompleteListener<Void>()
                                    {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                            ...
                                            {
                                                Toast.makeText(Registration_admin.this, "Congratulations admin, your account has been created.", Toast.LENGTH_SHORT).show();
                                            ...
                                            else
                                            {
                                                ...
                                                Toast.makeText(Registration_admin.this, "Network error...Please try again", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                        }
                        ...
                        {
                            Toast.makeText(Registration_admin.this, "This " + phone_no + "already exists", Toast.LENGTH_SHORT).show();
                            Toast.makeText(Registration_admin.this, "Please try again using another phone number", Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Intent loginintent =new Intent(Registration_admin.this,Login_admin.class);
